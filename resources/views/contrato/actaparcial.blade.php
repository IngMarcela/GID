...
@include('alertas.request')
	{!!Form::open(['class' => 'form-horizontal','route' => 'actaparcial.store','method' => 'POST'])!!}
	<div class="row">
 		<div class="pane">
			...
			<div class="portfolio-items">
				<div class="col-sm-6 portfolio-item branded logos">
					<div class="form-group"><!-- label de folio inicial -->
						...
						<div class="col-xs-3"><!-- opciones en el valor del folio inicial -->
							<!-- variable $folio_inicial es enviada desde el controlador ContratoController@create -->
    ...
    <div class="portfolio-items">
    	<div class="col-sm-6 portfolio-item branded logos">
    		<div class="form-group"><!-- label de detalle  -->
				...
				<div class="col-xs-3"><!-- caja de detalle -->	
