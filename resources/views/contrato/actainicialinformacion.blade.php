...
<!-- formulario -->
    ...
    <div class="portfolio-items">
    	<div class="col-sm-6 portfolio-item branded logos">
    		<div class="form-group">
				{!!Form::label('No Acta', null, array('class' => 'control-label col-xs-3'))!!}	
				<div class="col-xs-3">
				
				{!!Form::text('No Acta',$acta->no,['class'=>'form-control-3','placeholder'=>'No Acta','readonly' => 'true'])!!}		
				</div>	
			</div>
    	</div>
    </div> 
    ...
    <div class="portfolio-items">
    	<div class="col-sm-6 portfolio-item branded logos">
    		<div class="form-group">
				...
				<div class="col-xs-3">	
					{!!Form::date('Fecha_de_Firma',$acta->fecha_inicial,['class'=>'form-control-3','readonly' => 'true'])!!}
				</div>	
			</div>
    	</div>
    </div>  
    <div class="portfolio-items">
    	<div class="col-sm-6 portfolio-item branded logos">
    		<div class="form-group">
				{!!Form::label('Fecha de vencimiento', null, array('class' => 'control-label col-xs-3'))!!}	
				<div class="col-xs-3">	
					{!!Form::date('Fecha_de_Vencimiento',$acta->vencimiento,['class'=>'form-control-3','readonly' => 'true'])!!}
				</div>	
			</div>
    	</div>
    </div> 
